...
| [{{ algorithms.title }}]({{ algorithms.permalink }}) | [{{ misinformation.title }}]({{ misinformation.permalink }}) | {% for reading in misinformation.readings %} {% if reading.syllabus %} * {% include get_reading.html reading=reading %} <br> {% endif %} {% endfor %} |          
